...
class DecodeSignedLikeRequest
{
	...
	public function __construct($_fbAppSecret) {
		...
		$this->getLikeStatus($_fbAppSecret);
	
	}
	
	private function getLikeStatus($_fbAppSecret)
	{
		...
		if ($_signed['page']['liked'] == 1) { $this->set('likeStatus',true); }
	}
